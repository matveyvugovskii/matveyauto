    ...
    <footer id="contact" className="bg-slate-900 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold tracking-tight">
                AquaGloss<span className="text-blue-500">Pro</span>
              </span>
            </div>
            <p className="text-slate-400 max-w-sm mb-6">
              Ваша преміальна автомийка та детейлінг-центр. Ми піклуємося про ваше авто як про своє власне.
            </p>
          ...
          <div>
            <h4 className="font-bold text-lg mb-6">Компанія</h4>
            <ul className="space-y-4 text-slate-400">
              <li><a href="#services" className="hover:text-blue-500 transition-colors">Послуги</a></li>
              <li><a href="#" className="hover:text-blue-500 transition-colors">Про нас</a></li>
              <li><a href="#" className="hover:text-blue-500 transition-colors">Акції</a></li>
              <li><a href="#" className="hover:text-blue-500 transition-colors">Кар'єра</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:row justify-between items-center text-slate-500 text-sm">
          <p>© 2024 AquaGloss Pro. Всі права захищені.</p>
